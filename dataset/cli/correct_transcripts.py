...
def _parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--speech-all", type=Path, default=Path("dataset/data/pipeline/all.jsonl"))
    parser.add_argument(
        "--speech-output-dir",
        type=Path,
        default=Path("dataset/data/pipeline"),
    ...
    parser.add_argument(
        "--cache-dir",
        type=Path,
        default=Path("dataset/data/pipeline/text_correction"),
    )
    parser.add_argument(
        "--agent-priority",
