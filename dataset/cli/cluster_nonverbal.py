...
from dataset.acoustic_segmentation import AcousticSegmentationConfig
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-response-dir",
        type=Path,
        default=Path("dataset/data/pipeline/raw_responses"),
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("dataset/data/pipeline/nonverbal_clustering"),
    )
    parser.add_argument(
        "--beats-code-dir",
        type=Path,
        default=Path("dataset/data/pipeline/_models/beats/code"),
    )
    parser.add_argument(
        "--beats-checkpoint",
        type=Path,
        default=Path("dataset/data/pipeline/_models/beats/BEATs_iter3_plus_AS2M.pt"),
    )
