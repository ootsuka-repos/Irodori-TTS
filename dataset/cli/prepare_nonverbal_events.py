...
def _parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--feature-dir",
        type=Path,
        default=Path("dataset/data/pipeline/nonverbal_events"),
    ...
    parser.add_argument(
        "--manual-seeds",
        type=Path,
        default=Path("dataset/data/pipeline/manual_nonverbal_seeds.jsonl"),
    )
    parser.add_argument("--device", default="cuda:0")
    parser.add_argument(
        "--hf-cache-dir",
        type=Path,
        default=Path("dataset/data/pipeline/_models/hf"),
    )
    parser.add_argument(
