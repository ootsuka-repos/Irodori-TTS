...
from core.latents import patchify_latent, unpatchify_latent
from core.lora import checkpoint_state_uses_lora, is_lora_adapter_dir, load_lora_adapter
...
from .postprocessing import find_flattening_points
    ...
    def synthesize(
        ...
        *,
        ...
        with (
            ...
            t0 = _measure_start(self.model_device, self.codec_device)
            flattening_points = [latent_steps] * num_candidates
                ...
                for i in range(num_candidates):
                    ...
                    if bool(req.trim_tail):
                        flattening_samples = int(
                            flattening_points[i] * int(self.codec.model.hop_length)
                        )
