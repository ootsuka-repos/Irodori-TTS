...
class TrainConfig:
    ...
    dataloader_prefetch_to_device: bool = True
    ...
    valid_every: int = 0
    # "sample" splits by manifest row; "speaker" keeps each speaker_id entirely
    # in train or valid to avoid same-voice leakage into the validation metric.
    ...
    # With pure_bf16, compute optimizer updates in fp32 and store params/moments
