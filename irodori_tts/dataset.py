...
from .latents import patchify_latent
...
class TTSCollator:
    ...
    return_unpatched_latents: bool = True
    ...
    def __call__(self, batch: list[dict[str, Any]]) -> dict[str, torch.Tensor]:
        ...
        if self.include_target_latent:
            ...
            if self.return_unpatched_latents:
                out.update(
                    {
                        "latent": latent_batch,
        ...
        if self.include_reference_latent:
            ...
            if self.return_unpatched_latents:
                out["ref_latent"] = ref_batch
                out["ref_latent_mask"] = ref_mask
