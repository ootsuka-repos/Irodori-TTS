...
from irodori_tts.training import (
...
def main() -> None:
    ...
    if args.dataloader_prefetch_to_device is not None:
        train_cfg = replace(
            train_cfg,
            dataloader_prefetch_to_device=bool(args.dataloader_prefetch_to_device),
        )
