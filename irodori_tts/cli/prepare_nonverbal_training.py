...
from irodori_tts.data_prep.nonverbal_training_manifest import (
...
def _parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    quality.add_argument("--minimum-seconds", type=float, default=5.0)
    quality.add_argument("--maximum-seconds", type=float, default=12.0)
    quality.add_argument("--classifier-minimum-probability", type=float, default=0.75)
    quality.add_argument("--classifier-minimum-margin", type=float, default=0.20)
    quality.add_argument("--neighbor-minimum-count", type=int, default=3)
    quality.add_argument("--neighbor-minimum-support", type=float, default=0.80)
    quality.add_argument("--neighbor-minimum-similarity", type=float, default=0.92)
    quality.add_argument("--speech-overlap-minimum-seconds", type=float, default=0.50)
