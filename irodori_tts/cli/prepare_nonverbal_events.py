...
from irodori_tts.data_prep.nonverbal_event_pipeline import (
    EventMergeConfig,
    ManualSeedConfig,
    PipelineConfig,
    run_nonverbal_event_pipeline,
)
from irodori_tts.data_prep.nonverbal_labeling import NonverbalLabelingConfig
from irodori_tts.data_prep.nonverbal_report import write_nonverbal_report
from irodori_tts.data_prep.nonverbal_subclustering import SubclusteringConfig
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--seed-prob", type=float, default=0.80)
    parser.add_argument("--seed-margin", type=float, default=0.50)
    parser.add_argument("--neighbors", type=int, default=7)
    parser.add_argument("--min-cosine", type=float, default=0.92)
    parser.add_argument("--neighbor-agreement", type=float, default=0.80)
    parser.add_argument(
        "--min-neighbors",
        type=int,
        default=3,
    ...
    parser.add_argument("--other-prob", type=float, default=0.75)
    parser.add_argument("--other-margin", type=float, default=0.20)
...
def main() -> None:
    ...
    summary = run_nonverbal_event_pipeline(
        ...
        labeling_config=NonverbalLabelingConfig(
